...
public class CellRecordClientExecer : ViRPCExecer
{
	public static CellRecordClientExecer Create() { return new CellRecordClientExecer(); }
	...
	protected void SetEntity(CellRecord entity)
	{
		_entity = entity;
	}
	...
	{
		switch((CellRecordClientMethod)funcIdx)
		{
			default:
