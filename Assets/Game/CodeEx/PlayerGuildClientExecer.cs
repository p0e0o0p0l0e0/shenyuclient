...
public class PlayerGuildClientExecer : PlayerComponentClientExecer
{
	public static PlayerGuildClientExecer Create() { return new PlayerGuildClientExecer(); }
	...
	protected void SetEntity(PlayerGuild entity)
	{
		_entity = entity;
	...
	{
		switch((PlayerGuildClientMethod)funcIdx)
		{
			default:
	...
	protected new PlayerGuild _entity;
}
