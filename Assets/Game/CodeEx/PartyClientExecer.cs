...
public class PartyClientExecer : ViRPCExecer
{
	public static PartyClientExecer Create() { return new PartyClientExecer(); }
	...
	protected void SetEntity(Party entity)
	{
		_entity = entity;
	}
	...
	{
		switch((PartyClientMethod)funcIdx)
		{
			default:
