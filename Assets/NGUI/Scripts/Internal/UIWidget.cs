...
public class UIWidget : UIRect
{
	...
	/// <summary>
	/// Custom: append to Collider's size; 
	/// The final size of Collider is (Auto Resized's size + ColliderSizeAppend)
	/// </summary>
	public Vector2 ColliderSizeAppend = Vector2.zero; 
	...
	public virtual void ResizeCollider () { if (NGUITools.GetActive(this)) NGUITools.UpdateWidgetCollider(gameObject); }
