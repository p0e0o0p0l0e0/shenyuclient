...
public class PlayerMailboxClientExecer : PlayerComponentClientExecer
{
	public static PlayerMailboxClientExecer Create() { return new PlayerMailboxClientExecer(); }
	...
	protected void SetEntity(PlayerMailbox entity)
	{
		_entity = entity;
	...
	{
		switch((PlayerMailboxClientMethod)funcIdx)
		{
			default:
	...
	protected new PlayerMailbox _entity;
}
