...
namespace ResourceFormat
{
    public class TextureViewer : BaseViewer
    {
        public TextureViewer(EditorWindow hostWindow)
        {
            ...
            m_dataTable.AddColumn("RootPath", "PackageRootPath", 0.3f, TextAnchor.MiddleLeft);
            m_dataTable.AddColumn("FileNameMatch", "Name", 0.09f);
            ...
            m_dataTable.AddColumn("ShapeType", "Shape", 0.05f);
            m_dataTable.AddColumn("AlphaMode", "AlphaMode", 0.06f);
