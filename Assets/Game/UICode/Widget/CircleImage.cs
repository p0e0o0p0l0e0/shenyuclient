...
public class CircleImage : BaseImage {
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        Vector4 uvInner = overrideSprite != null ? DataUtility.GetInnerUV(overrideSprite) : Vector4.zero;
        Vector4 padder = overrideSprite != null ? DataUtility.GetPadding(overrideSprite) : Vector4.zero;
