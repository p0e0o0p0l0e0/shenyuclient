...
public class ActivityRecordClientExecer : ViRPCExecer
{
	public static ActivityRecordClientExecer Create() { return new ActivityRecordClientExecer(); }
	...
	protected void SetEntity(ActivityRecord entity)
	{
		_entity = entity;
	}
	...
	{
		switch((ActivityRecordClientMethod)funcIdx)
		{
			default:
	...
	protected ActivityRecord _entity;
}
