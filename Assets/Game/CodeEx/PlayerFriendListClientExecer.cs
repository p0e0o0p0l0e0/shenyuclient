...
public class PlayerFriendListClientExecer : PlayerComponentClientExecer
{
	public static PlayerFriendListClientExecer Create() { return new PlayerFriendListClientExecer(); }
	...
	protected void SetEntity(PlayerFriendList entity)
	{
		_entity = entity;
	...
	{
		switch((PlayerFriendListClientMethod)funcIdx)
		{
			default:
	...
	protected new PlayerFriendList _entity;
}
