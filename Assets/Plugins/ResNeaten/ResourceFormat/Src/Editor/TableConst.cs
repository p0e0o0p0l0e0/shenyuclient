...
namespace ResourceFormat
{
    public class TableConst
    {
        ...
        public static string[] Modes = new string[] { "Texture", "Model" };
        ...
        public static string[] AndoridFormat = { "RGB24", "ETC_RGB4", "ETC2_RGB", "ASTC5x5" };
        public static string[] IosFormat = { "RGB24", "PVRTC_RGB4", "ASTC5x5" };
        ...
        public static TextureImporterFormat[] AndroidImporterFormat = { TextureImporterFormat.RGB24, TextureImporterFormat.ETC_RGB4, TextureImporterFormat.ETC2_RGB4, TextureImporterFormat.ASTC_RGBA_5x5 };
        public static TextureImporterFormat[] IosImporterFormat = { TextureImporterFormat.RGB24, TextureImporterFormat.PVRTC_RGB4, TextureImporterFormat.ASTC_RGBA_5x5 };
    }
