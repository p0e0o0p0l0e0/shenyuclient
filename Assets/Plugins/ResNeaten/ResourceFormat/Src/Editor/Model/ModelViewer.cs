...
namespace ResourceFormat
{
    public class ModelViewer : BaseViewer
    {
        ...
        public ModelViewer(EditorWindow hostWindow)
        {
            ...
            m_dataTable.AddColumn("ReadWriteEnable", "R/W", 0.03f);
            m_dataTable.AddColumn("ImportUV2", "uv2", 0.03f);
            m_dataTable.AddColumn("ImportUV3", "uv3", 0.02f);
            m_dataTable.AddColumn("ImportUV4", "uv4", 0.02f);
            ...
            m_dataTable.AddColumn("AnimationType", "AnimationType", 0.1f);
            ...
            m_showTable.AddColumn("Path", "Path", 0.3f, TextAnchor.MiddleLeft);
            ...
            m_showTable.AddColumn("AnimationType", "AnimationType", 0.1f);
        ...
        public override void Draw(Rect r)
        {
            ...
            GUILayout.BeginHorizontal(TableStyles.Toolbar);
            {
                ...
                if (GUILayout.Button("Refresh Select Data", TableStyles.ToolbarButton, GUILayout.MaxWidth(140)))
                {
                    ...
                    {
                        m_control.RefreshDataByRootPath();
                    }
                }
