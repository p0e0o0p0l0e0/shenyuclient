...
public class UIButtonEditor : UIButtonColorEditor
{
	...
	protected override void DrawProperties ()
	{
		...
		DrawTransition();
		sp = serializedObject.FindProperty("UseColorEffect");
		bool result = EditorGUILayout.Toggle("UseColorEffect", sp.boolValue);
		sp.boolValue = result;
		if (result) DrawColors();
		//
		NGUIEditorTools.DrawProperty("ButtonText", serializedObject, "TextLabel");
		//
		...
		//+++++++
		NGUIEditorTools.DrawEvents("On Released ( press is false ) ", button, button.onReleased, false);
		NGUIEditorTools.DrawProperty("Click CD(s)", serializedObject, "ClickCD");
	}
}
