...
public class TradeManagerClientExecer : ViRPCExecer
{
	public static TradeManagerClientExecer Create() { return new TradeManagerClientExecer(); }
	...
	protected void SetEntity(TradeManager entity)
	{
		_entity = entity;
	}
	...
	{
		switch((TradeManagerClientMethod)funcIdx)
		{
			default:
	...
	protected TradeManager _entity;
}
