...
public class EventDelegate
{
	...
	static void CopyParameters(EventDelegate dest, EventDelegate src)
	{
		if (src.mParameters != null && src.mParameters.Length > 0)
		{
			dest.mParameters = new Parameter[src.mParameters.Length];
			for (int i = 0; i < src.mParameters.Length; ++i)
				dest.mParameters[i] = src.mParameters[i];
		}
	}
