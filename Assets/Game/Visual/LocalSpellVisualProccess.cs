...
public class LocalSpellVisualProccess
{
    public bool IsLoop { get { return _loop; } }
    public LocalSpaceEntity Entity { get { return _entity; } }
    public ViExpressOwnList<ViExpressInterface> ExpressList { get { return _ownExpressList; } }

    public void Start(LocalSpaceEntity entity)
    {
        _entity = entity;
    }
    public void End()
    ...
    public void OnceExec(LocalSpaceEntity gameUnit, VisualSpellProcStruct info)
    {
        ...
        for (int iter = 0; iter < info.Shake.Length; ++iter)
        {
            ...
            if (iterShake.Broadcast == (UInt32)BoolValue.FALSE)
            {
                continue;
            }
        ...
        if (auraVisual != null)
        {
            _durationEffect.Start(gameUnit, gameUnit.VisualBody, auraVisual, "Red");
    ...
    public void EndExec(LocalSpaceEntity gameUnit, bool breakVisual)
    {
        if (_info == null)
        {
            return;
    ...
    public void StopLoopAnim(LocalSpaceEntity gameUnit)
    {
        if (_info == null)
        {
            return;
