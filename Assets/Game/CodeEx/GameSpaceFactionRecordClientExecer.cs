...
public class GameSpaceFactionRecordClientExecer : ViRPCExecer
{
	public static GameSpaceFactionRecordClientExecer Create() { return new GameSpaceFactionRecordClientExecer(); }
	...
	protected void SetEntity(GameSpaceFactionRecord entity)
	{
		_entity = entity;
	}
	...
	{
		_entity = new GameSpaceFactionRecord();
		SetEntity(_entity);
	...
	{
		switch((GameSpaceFactionRecordClientMethod)funcIdx)
		{
			default:
	...
	protected GameSpaceFactionRecord _entity;
}
