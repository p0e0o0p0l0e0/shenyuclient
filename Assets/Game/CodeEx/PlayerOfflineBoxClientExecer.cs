...
public class PlayerOfflineBoxClientExecer : PlayerComponentClientExecer
{
	public static PlayerOfflineBoxClientExecer Create() { return new PlayerOfflineBoxClientExecer(); }
	...
	protected void SetEntity(PlayerOfflineBox entity)
	{
		_entity = entity;
	...
	{
		switch((PlayerOfflineBoxClientMethod)funcIdx)
		{
			default:
	...
	protected new PlayerOfflineBox _entity;
}
