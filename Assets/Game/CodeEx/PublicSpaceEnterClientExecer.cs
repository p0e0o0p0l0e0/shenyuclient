...
public class PublicSpaceEnterClientExecer : ViRPCExecer
{
	public static PublicSpaceEnterClientExecer Create() { return new PublicSpaceEnterClientExecer(); }
	...
	protected void SetEntity(PublicSpaceEnter entity)
	{
		_entity = entity;
	}
	...
	{
		switch((PublicSpaceEnterClientMethod)funcIdx)
		{
			default:
	...
	protected PublicSpaceEnter _entity;
}
