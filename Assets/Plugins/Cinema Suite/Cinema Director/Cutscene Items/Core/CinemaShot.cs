...
namespace CinemaDirector
{
    ...
    public class CinemaShot : CinemaGlobalAction, IRevertable
    {
        ...
        public override void Trigger()
        {
            ...
            {
#if !NoChange
                EventDispatcher.TriggerEvent<Camera, bool>("Story.CinemaDirectorCameraEvent", shotCamera, true);
#endif
        ...
        public override void End()
        {
            ...
            {
#if !NoChange
                EventDispatcher.TriggerEvent<Camera, bool>("Story.CinemaDirectorCameraEvent", shotCamera, false);
#endif
