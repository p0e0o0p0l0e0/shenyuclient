...
public class CellChatGroupClientExecer : ViRPCExecer
{
	public static CellChatGroupClientExecer Create() { return new CellChatGroupClientExecer(); }
	...
	protected void SetEntity(CellChatGroup entity)
	{
		_entity = entity;
	}
	...
	{
		switch((CellChatGroupClientMethod)funcIdx)
		{
			case CellChatGroupClientMethod.METHOD_0_OnChatScriptBegin: 
				_0_OnChatScriptBegin(IS);
				break;
			case CellChatGroupClientMethod.METHOD_1_OnChatScriptShowItem: 
				_1_OnChatScriptShowItem(IS);
				break;
			case CellChatGroupClientMethod.METHOD_2_OnChatScriptEnd: 
				_2_OnChatScriptEnd(IS);
				break;
			case CellChatGroupClientMethod.METHOD_3_OnChatMessage: 
				_3_OnChatMessage(IS);
				break;
			default:
	...
	protected CellChatGroup _entity;
}
