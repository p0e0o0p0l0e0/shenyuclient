...
public class UIButton : UIButtonColor
{
	...
	public delegate void ChangeButtonState(UIButton button, bool state);
	public ChangeButtonState OnButtonEnableChange;
	//
	...
	public List<EventDelegate> onReleased = new List<EventDelegate>();
	...
	public override bool isEnabled
	{
		...
		set
		{
			...
			if (TextLabel != null)
			{
				UILabel.Effect style = value ? UILabel.Effect.Outline : UILabel.Effect.None;
				TextLabel.effectStyle = style;
			}
			if (OnButtonEnableChange != null)
			{
				OnButtonEnableChange(this, value);
			}
		}
	}
	...
	protected override void OnInit()
	{
		...
		if (TextLabel == null)
		{
			TextLabel = GetComponentInChildren<UILabel>(true);
		}
	}
	...
	protected virtual void OnClick()
	{
		if (current == null && isEnabled)
		{
			...
			//
			if (OnPlayClickSoundCallback != null)
			{
				OnPlayClickSoundCallback();
			}
			//
			current = null;
		}
	...
	protected override void OnPress(bool isPressed)
	{
		...
		if (isEnabled && UICamera.currentTouch != null)
		{
			if (!isPressed)
			{
				...
				if (_preClickTime + ClickCD < time)
				{
					if (!UICamera.currentTouch.dragStarted)
					{
						EventDelegate.Execute(onReleased);
						//
						if (OnPlayClickSoundCallback != null)
						{
							OnPlayClickSoundCallback();
