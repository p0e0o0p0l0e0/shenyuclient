...
//
//
public class ActivityRecord : ViRPCEntity, ViEntity
{
	public ViRPCInvoker RPC { get { return _RPC; } }
	ViRPCInvoker _RPC = new ViRPCInvoker();
	public string Name { get { return "ActivityRecord"; } }
	...
	public ActivityRecordReceiveProperty Property { get { ViDebuger.AssertError(_property); return _property; } }
	...
	{
		_property = ViReceiveDataCache<ActivityRecordReceiveProperty>.Alloc();
	...
	{
		ViReceiveDataCache<ActivityRecordReceiveProperty>.Free(_property);
		_property = null;
	}
	...
	UInt32 _PackID;
	bool _active;
	ActivityRecordReceiveProperty _property;
}
