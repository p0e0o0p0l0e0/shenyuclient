...
public class PlayerTraderClientExecer : PlayerComponentClientExecer
{
	public static PlayerTraderClientExecer Create() { return new PlayerTraderClientExecer(); }
	...
	protected void SetEntity(PlayerTrader entity)
	{
		_entity = entity;
	...
	{
		switch((PlayerTraderClientMethod)funcIdx)
		{
			default:
	...
	protected new PlayerTrader _entity;
}
