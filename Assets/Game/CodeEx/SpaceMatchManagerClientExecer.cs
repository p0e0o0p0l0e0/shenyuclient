...
public class SpaceMatchManagerClientExecer : ViRPCExecer
{
	public static SpaceMatchManagerClientExecer Create() { return new SpaceMatchManagerClientExecer(); }
	...
	protected void SetEntity(SpaceMatchManager entity)
	{
		_entity = entity;
	}
	...
	{
		switch((SpaceMatchManagerClientMethod)funcIdx)
		{
			default:
	...
	protected SpaceMatchManager _entity;
}
